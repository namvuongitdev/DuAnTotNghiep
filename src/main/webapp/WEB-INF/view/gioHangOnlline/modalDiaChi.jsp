            ...
            <c:if test="${diaChis != null}">
                ...
                <c:forEach items="${diaChis}" var="thongTinKhachHang">
                    <div class="row" id="showTongTinKhachHang"
                         onclick="findDiaChiOnline({hoTen:`${thongTinKhachHang.hoTen}` , sdt:`${thongTinKhachHang.sdt}` , diaChi:`${thongTinKhachHang.diaChi}`})">
                        ...
                        <c:if test="${!thongTinKhachHang.diaChiMacDinh}">
                            <div><button class="btn btn-danger">Mặc đinh</button></div>
                        </c:if>
                    </div>
                </c:forEach>
            </c:if>
