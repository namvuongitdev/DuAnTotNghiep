            ...
            <sec:authorize access="hasAnyAuthority('STAFF' , 'ADMIN')">
                ...
                <li class="nav-item">
                    <a href="/admin/hoa-don/hien-thi" class="nav-link align-middle px-0">
                        ...
                        <span class="ms-1 d-none d-sm-inline" <%=request.getRequestURI().contains("quanLyHoaDon") ? "style=\"background-color: #29B5D4\"" : ""  %>><font
                                color="black">Quản Lý Hóa Đơn</font></span>
                    </a>
                </li>
            </sec:authorize>
            <sec:authorize access="hasAuthority('ADMIN')">
