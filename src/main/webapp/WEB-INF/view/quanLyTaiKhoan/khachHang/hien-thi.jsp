                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="get"  action="/admin/khach-hang/filter" modelAttribute="${filterKhachHang}">
                                            <jsp:include page="../khachHang/filter.jsp"/>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button  style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" type="button"
                                                        ...
                                                        ${nv.trangThai == 0 ? 'Kích hoạt' : 'Hủy'}</button>
                                            </td>
                                            <td>
                                ...
                                <div class="container-fluid mt-5">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-center">
                                            <li class="page-item ${lst.number + 1<=1?"disabled":""}"><a class="page-link"
                                                                                                                href="${url}${(lst.number + 1) - 1}"><</a>
                                            </li>
                                            <c:forEach begin="1" end="${lst.getTotalPages()}" var="i">
                                                <li class="page-item"><a class="page-link ${i == lst.number + 1 ? 'active ' : ''}"
                                                                         href="${url}${i}">${i}</a></li>
                                            </c:forEach>
                                            <li class="page-item ${lst.number + 1 >= lst.getTotalPages() ? "disabled":  ""}">
                                                <a class="page-link"
                                                   href="${url}${(lst.number + 1) + 1}">></a>
                                            </li>
                                        </ul>
