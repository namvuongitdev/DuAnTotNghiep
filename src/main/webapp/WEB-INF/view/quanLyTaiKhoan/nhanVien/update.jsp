            ...
            <section class="section">
                <div class="card">
                    <div class="card-body row">
                        ...
                        <form:form action="/admin/nhan-vien/update/${nhanVien.id}" method="post" modelAttribute="nhanVien" id="yourForm">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                ...
                <div class="modal" id="exampleModalChucVu" tabindex="-1">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <form:form method="post" action="/admin/nhan-vien/modal-update-chuc-vu?id=${nhanVien.id}" modelAttribute="chucVu" class="row g-3" id="yourFormCV">
