            ...
            <section class="section">
                ...
                <div class="card" id="cardAdd" style="display: none;">
                    <div class="card-body row">
                        ...
                        <form id="colorForm" method="post" action="/admin/chat-lieu/save" modelAttribute="chatLieu" class="row g-3" onsubmit="return false;">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten" class="form-control" id="floatingName" placeholder="Tên chất liệu"/>
                                    <label for="floatingName">Tên chất liệu <span style="color: red">(*)</span></label>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${list.content}" var="lst" varStatus="i">
                                        <tr style="text-align: center">
                                            ...
                                            <td>
                                                <a id="showButton" class="btn btn-success text-white" title="Sửa dữ liệu" style="text-decoration: none" href="/admin/chat-lieu/hien-thi/${lst.id}"><i class="bi bi-pencil"></i></a>
