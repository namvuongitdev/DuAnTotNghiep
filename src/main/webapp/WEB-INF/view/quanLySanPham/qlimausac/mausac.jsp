            ...
            <section class="section">
                ...
                <div class="card" id="cardAdd" style="display: none;">
                    <div class="card-body row">
                        ...
                        <form id="colorForm" method="post" action="/admin/mau-sac/save" modelAttribute="mauSac" class="row g-3" onsubmit="return false;">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten" class="form-control" id="floatingName" placeholder="Tên màu"/>
                                    <label for="floatingName">Tên màu <span style="color: red">(*)</span></label>
