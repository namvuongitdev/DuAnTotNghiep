            ...
            <section class="section">
                ...
                <div class="card" id="cardUpdate">
                    <div class="card-body row">
                        ...
                        <form id="colorForm" method="post" action="/admin/danh-muc/update/${dl.id}" modelAttribute="danhMuc" class="row g-3" onsubmit="return false;">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten" class="form-control" id="floating" placeholder="Tên danh mục" value="${dl.ten}"/>
                                    <label for="floating">Tên danh mục <span style="color: red">(*)</span></label>
