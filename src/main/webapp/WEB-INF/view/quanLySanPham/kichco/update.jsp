                ...
                <div class="card" id="cardUpdate">
                    <div class="card-body row">
                        ...
                        <div class="col-2 card-title">
                            <a class="btn btn-danger text-white" title="Sửa dữ liệu" style="text-decoration: none" href="/admin/size/hien-thi"><i class="bi bi-x"></i></a>
                        </div>
                        <!-- Floating Labels Form -->
                        <form id="colorForm" method="post" action="/admin/size/update/${dl.id}" modelAttribute="size" class="row g-3" onsubmit="return false;">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten" class="form-control" id="floating" placeholder="Tên kích cỡ" value="${dl.ten}"/>
                                    <label for="floating">Tên kích cỡ <span style="color: red">(*)</span></label>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${list.content}" var="lst" varStatus="i">
                                        <tr style="text-align: center">
                                            ...
                                            <td>
                                                <a id="showButton" class="btn btn-success text-white" title="Sửa dữ liệu" style="text-decoration: none" href="/admin/size/hien-thi/${lst.id}"><i class="bi bi-pencil"></i></a>
...
<script>
    ...
    function validateForm(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (!regex.test(input)) {
                    errorDiv.textContent = 'Tên kích cỡ không hợp lệ';
                } else {
