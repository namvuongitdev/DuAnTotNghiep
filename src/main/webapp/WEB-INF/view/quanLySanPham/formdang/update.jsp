            ...
            <section class="section">
                ...
                <div class="card" id="cardUpdate">
                    <div class="card-body row">
                        ...
                        <form id="colorForm" method="post" action="/admin/kieu-dang/update/${dl.id}" modelAttribute="kieuDang" class="row g-3" onsubmit="return false;">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ten" class="form-control" id="floating" placeholder="Tên kiểu dáng" value="${dl.ten}"/>
                                    <label for="floating">Tên kiểu dáng <span style="color: red">(*)</span></label>
